  ...
  module ConsoleHelper
    ...
    def console_connection_info(appname)
      ...
      if !entry[:console_port]
        return display ("Console access not supported for [#{appname}]. " +
          "Try running 'vmc files #{appname} app/cf-rails-console'. " +
          "If the directory is not found, you need to redeploy your app.").red
      end
